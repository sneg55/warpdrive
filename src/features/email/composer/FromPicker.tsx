// FromPicker: the sender address as it appears in the composer's From row (ComposerHeader owns
// the row itself). Single-mailbox today, so it renders as plain text, no
